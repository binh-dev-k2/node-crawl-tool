...
//                 var c = t.pageX || t.originalEvent.touches[0].pageX,
//                     r = t.pageY || t.originalEvent.touches[0].pageY;
...
//                         m,
//                         g,
//                         f = t.pageX || t.originalEvent.touches[0].pageX,
//                         v = t.pageY || t.originalEvent.touches[0].pageY;
//                     console.warn("Y-" + v),
//                         console.warn("startY-" + r),
//                         (i = f - c),
//                         (d = r - v),
//                         console.warn("pullDeltaX->" + i),
//                         (i || d) &&
//                             ((o = !0),
//                             (l = i / 10),
//                             (degY = d / 10),
...
//                                           "deg)"
//                                   ),
//                             console.warn("pullDeltaY->" + d),
//                             (u = i / 100),
//                             (p = d / 100),
//                             console.warn("opacityY->" + p),
//                             (m = u <= 0 ? 0 : u),
//                             console.warn("likeOpacity--" + m),
//                             (g = p <= 0 ? 0 : p),
//                             console.warn("superlikeOpacity-" + g),
...
//                                               .addClass("below")
//                                               .removeClass(
//                                                   "inactive to-upside to-downside"
//                                               ),
//                                               n();
//                                       }, 300)),
//                                   80 > Math.abs(d) && e.addClass("reset"),
//                                   setTimeout(function () {
//                                       e
//                                           .attr("style", "")
//                                           .removeClass("reset")
...
//                                               .addClass("below")
//                                               .removeClass(
//                                                   "inactive to-left to-right"
//                                               ),
//                                               n();
//                                       }, 300)),
//                                   80 > Math.abs(i) && e.addClass("reset"),
//                                   setTimeout(function () {
//                                       e
//                                           .attr("style", "")
//                                           .removeClass("reset")
